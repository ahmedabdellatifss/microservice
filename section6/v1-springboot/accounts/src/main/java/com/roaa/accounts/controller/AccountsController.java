...
@Tag(
        ...
        description = "CRUD REST API for Accounts in EazyBank To Create, Update, fetch and delete accounts"
)
@RestController
...
public class AccountsController {
    ...
    @Operation(
            ...
            description = "Create Account REST API for Accounts in EazyBank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
